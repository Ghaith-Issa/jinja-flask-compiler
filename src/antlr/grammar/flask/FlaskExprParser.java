...
public class FlaskExprParser extends Parser {
	...
	public static final int
		...
		FROM=24, IMPORT=25, GLOBAL=26, RETURN=27, TRUE=28, FALSE=29, NONE=30, 
		NAME=31, NUMBER=32, STRING=33, NEWLINE=34, WS=35, COMMENT=36, BLOCKSTART=37, 
		BLOCKEND=38, GT=39, LT=40, GTE=41, LTE=42, NEQ=43;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_globalstatement = 2, RULE_decorator = 3, 
		RULE_functionDef = 4, RULE_forstatement = 5, RULE_ifstatement = 6, RULE_importstatement = 7, 
		RULE_packageName = 8, RULE_importList = 9, RULE_assignment = 10, RULE_returnStmt = 11, 
		RULE_expr = 12;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "globalstatement", "decorator", "functionDef", 
			"forstatement", "ifstatement", "importstatement", "packageName", "importList", 
			"assignment", "returnStmt", "expr"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'('", "')'", "'['", "']'", "'{'", "'}'", "'@'", "'.'", "','", 
			"':'", "'='", "'=='", "'+'", "'-'", "'*'", "'/'", "'break'", "'continue'", 
			"'def'", "'if'", "'else'", "'for'", "'in'", "'from'", "'import'", "'global'", 
			"'return'", "'True'", "'False'", "'None'", null, null, null, null, null, 
			null, "'<BLOCKSTART>'", "'<BLOCKEND>'", "'>'", "'<'", "'>='", "'<='", 
			"'!='"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"GLOBAL", "RETURN", "TRUE", "FALSE", "NONE", "NAME", "NUMBER", "STRING", 
			"NEWLINE", "WS", "COMMENT", "BLOCKSTART", "BLOCKEND", "GT", "LT", "GTE", 
			"LTE", "NEQ"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17135698090L) != 0)) {
				{
				{
				setState(26);
				statement();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class GlobalStmtContext extends StatementContext {
		public GlobalstatementContext globalstatement() {
			return getRuleContext(GlobalstatementContext.class,0);
		}
		public GlobalStmtContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FlaskExprParserVisitor ) return ((FlaskExprParserVisitor<? extends T>)visitor).visitGlobalStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public static class GlobalstatementContext extends ParserRuleContext {
		public TerminalNode GLOBAL() { return getToken(FlaskExprParser.GLOBAL, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FlaskExprParserVisitor ) return ((FlaskExprParserVisitor<? extends T>)visitor).visitGlobalstatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case LBRACK:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16911433770L) != 0)) {
					{
					setState(155);
					expr(0);
					setState(160);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						setState(197);
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 17042430234624L) != 0)) ) {
